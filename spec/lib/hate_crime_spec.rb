...
describe HateCrime do
  ...
  describe "victim_count_filter_by_bias" do
    ...
    context "filter by 1 bias" do
      it "returns the victim count" do
        ...
        expect(HateCrime.filter_by_bias("cat")).to eq(3)
      end
    end
    ...
    context "bias doesn't exist" do
      it "returns 0" do
        ...
        expect(HateCrime.filter_by_bias("chimp")).to eq(0)
      end
    end
    ...
    context "multiple biases" do
      it "returns the victim count" do
        ...
        expect(HateCrime.filter_by_bias("turtle", "cat")).to eq(5)
      end
    end

  end

  describe "victim_count_filter_by_offense" do
    let(:victim_counts) do
      [
        {
          "total" => 2,
    ...
    context "filter by 1 offense" do
      it "returns the victim count" do
        ...
        expect(HateCrime.filter_by_offense("dropped")).to eq(4)
      end
    end
    ...
    context "bias doesn't exist" do
      it "returns 0" do
        ...
        expect(HateCrime.filter_by_offense("blah")).to eq(0)
      end
    end
    ...
    context "multiple biases" do
      it "returns the victim count" do
        ...
        expect(HateCrime.filter_by_offense("dropped", "poked")).to eq(5)
      end
    end
