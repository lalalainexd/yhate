$(document).ready(function(){
 ...
 $('#colorSelector').ColorPicker({
    ...
    onChange: function (hsb, hex, rgb) {
        $('header,.navbar-inner,#colorSelector').css("background", "#" + hex);
    }
...
$('#footercolor').ColorPicker({
    ...
    onChange: function (hsb, hex, rgb) {
        $('footer, #footercolor').css("background", "#" + hex);
...
$('header h1').ColorPicker({
    ...
    onChange: function (hsb, hex, rgb) {
        $('header h1').css("color", "#" + hex);
       
    }
});
$('#features h1').ColorPicker({
    color: '#0000ff',
    onShow: function (colpkr) {
        $(colpkr).fadeIn(500);
        return false;
...
$('#bodycolor').ColorPicker({
    ...
    onChange: function (hsb, hex, rgb) {
        $('body,#bodycolor').css("background", "#" + hex);
